...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-blue-300 to-cyan-200 gap-2 py-20 px-4 sm:px-6 lg:px-8">
      
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="font-heading text-4xl md:text-6xl font-bold text-foreground mb-6 text-balance">
            Professional Services for 
        <span className="bg-gradient-to-r from-blue-600  to-cyan-600 bg-clip-text text-transparent gap-2">
                  Modern Businesses
            </span>
          </h1>
      ...
      {/* Services Grid */}
      <section className="bg-gradient-to-r from-blue-300 to-cyan-200 py-16 px-4 sm:px-6 lg:px-8">
